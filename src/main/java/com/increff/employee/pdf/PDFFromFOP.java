package com.increff.employee.pdf;
...
public class PDFFromFOP {
	...
	public static void javaToXML(OrderInvoice emp) {
	...
	public static void generatePDF(int id) {
		try {
			...
			File xsltfile = new File("src\\main\\resources\\com\\increff\\employee\\style.xsl");
			File pdfDir = new File("./src/main/resources/com/increff/employee");
			pdfDir.mkdirs();
	...
	public static void generateResponse(HttpServletResponse response) throws IOException {
		...
		File pdfFile = new File("src\\main\\resources\\com\\increff\\employee\\receipt.pdf");
